...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupStatPersentage.order'
        db.add_column('vkontakte_groups_groupstatpercentage', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroupStatPersentage.order'
        db.delete_column('vkontakte_groups_groupstatpercentage', 'order')
