...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GroupStatPersentage.value'
        db.alter_column('vkontakte_groups_groupstatpercentage', 'value', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'GroupStatPersentage.percents'
        db.alter_column('vkontakte_groups_groupstatpercentage', 'percents', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'GroupStatPersentage.value'
        db.alter_column('vkontakte_groups_groupstatpercentage', 'value', self.gf('django.db.models.fields.PositiveIntegerField')(default=None))

        # Changing field 'GroupStatPersentage.percents'
        db.alter_column('vkontakte_groups_groupstatpercentage', 'percents', self.gf('django.db.models.fields.FloatField')(default=None))
