...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.is_admin'
        db.alter_column(u'vkontakte_groups_group', 'is_admin', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Group.is_closed'
        db.alter_column(u'vkontakte_groups_group', 'is_closed', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Group.is_admin'
        db.alter_column(u'vkontakte_groups_group', 'is_admin', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Group.is_closed'
        db.alter_column(u'vkontakte_groups_group', 'is_closed', self.gf('django.db.models.fields.BooleanField')())
