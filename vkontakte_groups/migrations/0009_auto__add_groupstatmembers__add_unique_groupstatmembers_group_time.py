...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('vkontakte_groups', ['GroupStatMembers'])

        # Adding unique constraint on 'GroupStatMembers', fields ['group', 'time']
        db.create_unique('vkontakte_groups_groupstatmembers', ['group_id', 'time'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'GroupStatMembers', fields ['group', 'time']
        db.delete_unique('vkontakte_groups_groupstatmembers', ['group_id', 'time'])

        # Deleting model 'GroupStatMembers'
