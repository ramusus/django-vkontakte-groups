...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupStatMembers.members_deactivated_entered'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_deactivated_entered', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'GroupStatMembers.members_deactivated_left'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_deactivated_left', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'GroupStatMembers.members_has_avatar_entered'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_entered', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'GroupStatMembers.members_has_avatar_left'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_left', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'GroupStatMembers.members_deactivated_entered'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_deactivated_entered')

        # Deleting field 'GroupStatMembers.members_deactivated_left'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_deactivated_left')

        # Deleting field 'GroupStatMembers.members_has_avatar_entered'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_entered')

        # Deleting field 'GroupStatMembers.members_has_avatar_left'
