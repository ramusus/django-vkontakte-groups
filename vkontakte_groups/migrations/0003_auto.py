...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Group', fields ['fetched']
        db.create_index(u'vkontakte_groups_group', ['fetched'])


    def backwards(self, orm):
        # Removing index on 'Group', fields ['fetched']
        db.delete_index(u'vkontakte_groups_group', ['fetched'])
