...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupStat.act_visitors'
        db.add_column('vkontakte_groups_groupstat', 'act_visitors', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'GroupStat.act_members'
        db.add_column('vkontakte_groups_groupstat', 'act_members', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroupStat.act_visitors'
        db.delete_column('vkontakte_groups_groupstat', 'act_visitors')

        # Deleting field 'GroupStat.act_members'
        db.delete_column('vkontakte_groups_groupstat', 'act_members')
