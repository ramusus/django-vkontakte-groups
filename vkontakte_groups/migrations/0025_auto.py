...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Group', fields ['screen_name']
        db.create_index('vkontakte_groups_group', ['screen_name'])

    def backwards(self, orm):
        # Removing index on 'Group', fields ['screen_name']
        db.delete_index('vkontakte_groups_group', ['screen_name'])
