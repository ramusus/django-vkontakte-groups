...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GroupStatMembers.time'
        db.alter_column('vkontakte_groups_groupstatmembers', 'time', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'GroupStatMembers.time'
        db.alter_column('vkontakte_groups_groupstatmembers', 'time', self.gf('django.db.models.fields.DateTimeField')(default=None))
