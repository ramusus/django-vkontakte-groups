...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.verified'
        db.add_column(u'vkontakte_groups_group', 'verified',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.verified'
        db.delete_column(u'vkontakte_groups_group', 'verified')
