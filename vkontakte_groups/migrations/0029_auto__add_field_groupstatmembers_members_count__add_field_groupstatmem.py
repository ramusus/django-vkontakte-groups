...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupStatMembers.members_count'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GroupStatMembers.members_entered_count'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_entered_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GroupStatMembers.members_left_count'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_left_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GroupStatMembers.members_deactivated_entered_count'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_deactivated_entered_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GroupStatMembers.members_deactivated_left_count'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_deactivated_left_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GroupStatMembers.members_has_avatar_entered_count'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_entered_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GroupStatMembers.members_has_avatar_left_count'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_left_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

#
#        # Changing field 'GroupStatMembers.members_left_ids'
#        db.alter_column('vkontakte_groups_groupstatmembers', 'members_left_ids', self.gf('picklefield.fields.PickledObjectField')())
#
#        # Changing field 'GroupStatMembers.members_has_avatar_entered_ids'
#        db.alter_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_entered_ids', self.gf('picklefield.fields.PickledObjectField')())
#
#        # Changing field 'GroupStatMembers.members_deactivated_left_ids'
#        db.alter_column('vkontakte_groups_groupstatmembers', 'members_deactivated_left_ids', self.gf('picklefield.fields.PickledObjectField')())
#
#        # Changing field 'GroupStatMembers.members_ids'
#        db.alter_column('vkontakte_groups_groupstatmembers', 'members_ids', self.gf('picklefield.fields.PickledObjectField')())
#
#        # Changing field 'GroupStatMembers.members_has_avatar_left_ids'
#        db.alter_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_left_ids', self.gf('picklefield.fields.PickledObjectField')())
#
#        # Changing field 'GroupStatMembers.members_entered_ids'
#        db.alter_column('vkontakte_groups_groupstatmembers', 'members_entered_ids', self.gf('picklefield.fields.PickledObjectField')())
#
#        # Changing field 'GroupStatMembers.members_deactivated_entered_ids'
#        db.alter_column('vkontakte_groups_groupstatmembers', 'members_deactivated_entered_ids', self.gf('picklefield.fields.PickledObjectField')())
    def backwards(self, orm):
        # Deleting field 'GroupStatMembers.members_count'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_count')

        # Deleting field 'GroupStatMembers.members_entered_count'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_entered_count')

        # Deleting field 'GroupStatMembers.members_left_count'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_left_count')

        # Deleting field 'GroupStatMembers.members_deactivated_entered_count'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_deactivated_entered_count')

        # Deleting field 'GroupStatMembers.members_deactivated_left_count'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_deactivated_left_count')

        # Deleting field 'GroupStatMembers.members_has_avatar_entered_count'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_entered_count')

        # Deleting field 'GroupStatMembers.members_has_avatar_left_count'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_left_count')


        # Changing field 'GroupStatMembers.members_left_ids'
        db.alter_column('vkontakte_groups_groupstatmembers', 'members_left_ids', self.gf('annoying.fields.JSONField')())

        # Changing field 'GroupStatMembers.members_has_avatar_entered_ids'
        db.alter_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_entered_ids', self.gf('annoying.fields.JSONField')())

        # Changing field 'GroupStatMembers.members_deactivated_left_ids'
        db.alter_column('vkontakte_groups_groupstatmembers', 'members_deactivated_left_ids', self.gf('annoying.fields.JSONField')())

        # Changing field 'GroupStatMembers.members_ids'
        db.alter_column('vkontakte_groups_groupstatmembers', 'members_ids', self.gf('annoying.fields.JSONField')())

        # Changing field 'GroupStatMembers.members_has_avatar_left_ids'
        db.alter_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_left_ids', self.gf('annoying.fields.JSONField')())

        # Changing field 'GroupStatMembers.members_entered_ids'
        db.alter_column('vkontakte_groups_groupstatmembers', 'members_entered_ids', self.gf('annoying.fields.JSONField')())

        # Changing field 'GroupStatMembers.members_deactivated_entered_ids'
        db.alter_column('vkontakte_groups_groupstatmembers', 'members_deactivated_entered_ids', self.gf('annoying.fields.JSONField')())
    models = {
        ...
        'vkontakte_groups.groupstatmembers': {
            ...
            'members_deactivated_entered_ids': ('picklefield.fields.PickledObjectField', [], {}),
            ...
            'members_deactivated_left_ids': ('picklefield.fields.PickledObjectField', [], {}),
            ...
            'members_entered_ids': ('picklefield.fields.PickledObjectField', [], {}),
            ...
            'members_has_avatar_entered_ids': ('picklefield.fields.PickledObjectField', [], {}),
            ...
            'members_has_avatar_left_ids': ('picklefield.fields.PickledObjectField', [], {}),
            'members_ids': ('picklefield.fields.PickledObjectField', [], {}),
            'members_left': ('django.db.models.fields.TextField', [], {}),
            'members_left_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'members_left_ids': ('picklefield.fields.PickledObjectField', [], {}),
