...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupStat.references'
        db.add_column('vkontakte_groups_groupstat', 'references',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.reach'
        db.add_column('vkontakte_groups_groupstat', 'reach',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.reach_subsribers'
        db.add_column('vkontakte_groups_groupstat', 'reach_subsribers',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.widget_users_views'
        db.add_column('vkontakte_groups_groupstat', 'widget_users_views',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.widget_members_views'
        db.add_column('vkontakte_groups_groupstat', 'widget_members_views',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.widget_new_users'
        db.add_column('vkontakte_groups_groupstat', 'widget_new_users',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupStat.widget_ex_users'
        db.add_column('vkontakte_groups_groupstat', 'widget_ex_users',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'GroupStat.references'
        db.delete_column('vkontakte_groups_groupstat', 'references')

        # Deleting field 'GroupStat.reach'
        db.delete_column('vkontakte_groups_groupstat', 'reach')

        # Deleting field 'GroupStat.reach_subsribers'
        db.delete_column('vkontakte_groups_groupstat', 'reach_subsribers')

        # Deleting field 'GroupStat.widget_users_views'
        db.delete_column('vkontakte_groups_groupstat', 'widget_users_views')

        # Deleting field 'GroupStat.widget_members_views'
        db.delete_column('vkontakte_groups_groupstat', 'widget_members_views')

        # Deleting field 'GroupStat.widget_new_users'
        db.delete_column('vkontakte_groups_groupstat', 'widget_new_users')

        # Deleting field 'GroupStat.widget_ex_users'
        db.delete_column('vkontakte_groups_groupstat', 'widget_ex_users')
