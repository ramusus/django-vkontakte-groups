...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'vkontakte_groups_group', u'id')


        # Changing field 'Group.remote_id'
        db.alter_column(u'vkontakte_groups_group', 'remote_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Group.id'
        db.add_column(u'vkontakte_groups_group', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)


        # Changing field 'Group.remote_id'
        db.alter_column(u'vkontakte_groups_group', 'remote_id', self.gf('django.db.models.fields.BigIntegerField')(unique=True))
