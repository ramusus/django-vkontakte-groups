...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupStat.section_discussions'
        db.add_column('vkontakte_groups_groupstat', 'section_discussions', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'GroupStat.section_audio'
        db.add_column('vkontakte_groups_groupstat', 'section_audio', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'GroupStat.section_video'
        db.add_column('vkontakte_groups_groupstat', 'section_video', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'GroupStat.section_photoalbums'
        db.add_column('vkontakte_groups_groupstat', 'section_photoalbums', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'GroupStat.section_applications'
        db.add_column('vkontakte_groups_groupstat', 'section_applications', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'GroupStat.section_documents'
        db.add_column('vkontakte_groups_groupstat', 'section_documents', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'GroupStat.activity_wall'
        db.add_column('vkontakte_groups_groupstat', 'activity_wall', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'GroupStat.activity_photos'
        db.add_column('vkontakte_groups_groupstat', 'activity_photos', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'GroupStat.activity_photo_comments'
        db.add_column('vkontakte_groups_groupstat', 'activity_photo_comments', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'GroupStat.activity_videos'
        db.add_column('vkontakte_groups_groupstat', 'activity_videos', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'GroupStat.activity_video_comments'
        db.add_column('vkontakte_groups_groupstat', 'activity_video_comments', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'GroupStat.activity_topics'
        db.add_column('vkontakte_groups_groupstat', 'activity_topics', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'GroupStat.activity_topic_comments'
        db.add_column('vkontakte_groups_groupstat', 'activity_topic_comments', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroupStat.section_discussions'
        db.delete_column('vkontakte_groups_groupstat', 'section_discussions')

        # Deleting field 'GroupStat.section_audio'
        db.delete_column('vkontakte_groups_groupstat', 'section_audio')

        # Deleting field 'GroupStat.section_video'
        db.delete_column('vkontakte_groups_groupstat', 'section_video')

        # Deleting field 'GroupStat.section_photoalbums'
        db.delete_column('vkontakte_groups_groupstat', 'section_photoalbums')

        # Deleting field 'GroupStat.section_applications'
        db.delete_column('vkontakte_groups_groupstat', 'section_applications')

        # Deleting field 'GroupStat.section_documents'
        db.delete_column('vkontakte_groups_groupstat', 'section_documents')

        # Deleting field 'GroupStat.activity_wall'
        db.delete_column('vkontakte_groups_groupstat', 'activity_wall')

        # Deleting field 'GroupStat.activity_photos'
        db.delete_column('vkontakte_groups_groupstat', 'activity_photos')

        # Deleting field 'GroupStat.activity_photo_comments'
        db.delete_column('vkontakte_groups_groupstat', 'activity_photo_comments')

        # Deleting field 'GroupStat.activity_videos'
        db.delete_column('vkontakte_groups_groupstat', 'activity_videos')

        # Deleting field 'GroupStat.activity_video_comments'
        db.delete_column('vkontakte_groups_groupstat', 'activity_video_comments')

        # Deleting field 'GroupStat.activity_topics'
        db.delete_column('vkontakte_groups_groupstat', 'activity_topics')

        # Deleting field 'GroupStat.activity_topic_comments'
        db.delete_column('vkontakte_groups_groupstat', 'activity_topic_comments')
