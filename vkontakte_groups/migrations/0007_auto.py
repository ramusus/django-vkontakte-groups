...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'vkontakte_groups_group_members')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('group', models.ForeignKey(orm[u'vkontakte_groups.group'], null=False)),
...
#        db.create_unique(m2m_table_name, ['group_id', 'user_id'])
        ...
        db.add_column('vkontakte_groups_group_members', 'time_from',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Comment.like_users.through.time_to'
        db.add_column('vkontakte_groups_group_members', 'time_to',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Removing M2M table for field members on 'Group'
        db.delete_table(db.shorten_name(u'vkontakte_groups_group_members'))
    ...
    models = {
        ...
        u'vkontakte_groups.group': {
            ...
            'members': ('m2m_history.fields.ManyToManyHistoryField', [], {'related_name': "'members_groups'", 'symmetrical': 'False', 'to': u"orm['vkontakte_users.User']"}),
            'members_count': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
