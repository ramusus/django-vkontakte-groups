...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('vkontakte_groups_group', 'name', self.gf('django.db.models.fields.CharField')(max_length=800))


    def backwards(self, orm):
        
        # Changing field 'Group.name'
        db.alter_column('vkontakte_groups_group', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))
