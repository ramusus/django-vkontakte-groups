...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.members_count'
        db.add_column(u'vkontakte_groups_group', 'members_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.members_count'
        db.delete_column(u'vkontakte_groups_group', 'members_count')
