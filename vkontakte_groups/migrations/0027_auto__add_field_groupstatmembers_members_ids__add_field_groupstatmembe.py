...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupStatMembers.members_ids'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_ids',
                      self.gf('annoying.fields.JSONField')(default=[]),
                      keep_default=False)

        # Adding field 'GroupStatMembers.members_entered_ids'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_entered_ids',
                      self.gf('annoying.fields.JSONField')(default=[]),
                      keep_default=False)

        # Adding field 'GroupStatMembers.members_left_ids'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_left_ids',
                      self.gf('annoying.fields.JSONField')(default=[]),
                      keep_default=False)

        # Adding field 'GroupStatMembers.members_deactivated_entered_ids'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_deactivated_entered_ids',
                      self.gf('annoying.fields.JSONField')(default=[]),
                      keep_default=False)

        # Adding field 'GroupStatMembers.members_deactivated_left_ids'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_deactivated_left_ids',
                      self.gf('annoying.fields.JSONField')(default=[]),
                      keep_default=False)

        # Adding field 'GroupStatMembers.members_has_avatar_entered_ids'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_entered_ids',
                      self.gf('annoying.fields.JSONField')(default=[]),
                      keep_default=False)

        # Adding field 'GroupStatMembers.members_has_avatar_left_ids'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_left_ids',
                      self.gf('annoying.fields.JSONField')(default=[]),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'GroupStatMembers.members_ids'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_ids')

        # Deleting field 'GroupStatMembers.members_entered_ids'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_entered_ids')

        # Deleting field 'GroupStatMembers.members_left_ids'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_left_ids')

        # Deleting field 'GroupStatMembers.members_deactivated_entered_ids'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_deactivated_entered_ids')

        # Deleting field 'GroupStatMembers.members_deactivated_left_ids'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_deactivated_left_ids')

        # Deleting field 'GroupStatMembers.members_has_avatar_entered_ids'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_entered_ids')

        # Deleting field 'GroupStatMembers.members_has_avatar_left_ids'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_has_avatar_left_ids')
    ...
    models = {
        ...
        'vkontakte_groups.groupstatmembers': {
            ...
            'members_deactivated_entered_ids': ('annoying.fields.JSONField', [], {}),
            'members_deactivated_left': ('django.db.models.fields.TextField', [], {}),
            'members_deactivated_left_ids': ('annoying.fields.JSONField', [], {}),
            'members_entered': ('django.db.models.fields.TextField', [], {}),
            'members_entered_ids': ('annoying.fields.JSONField', [], {}),
            'members_has_avatar_entered': ('django.db.models.fields.TextField', [], {}),
            'members_has_avatar_entered_ids': ('annoying.fields.JSONField', [], {}),
            'members_has_avatar_left': ('django.db.models.fields.TextField', [], {}),
            'members_has_avatar_left_ids': ('annoying.fields.JSONField', [], {}),
            'members_ids': ('annoying.fields.JSONField', [], {}),
            'members_left': ('django.db.models.fields.TextField', [], {}),
            'members_left_ids': ('annoying.fields.JSONField', [], {}),
