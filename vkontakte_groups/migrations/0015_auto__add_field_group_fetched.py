...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.fetched'
        db.add_column('vkontakte_groups_group', 'fetched', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Group.fetched'
        db.delete_column('vkontakte_groups_group', 'fetched')
