...
from vkontakte_groups.models import GroupStatMembers

class Migration(SchemaMigration):

    def forwards(self, orm):

        # Adding field 'GroupStatMembers.entered'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_entered', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'GroupStatMembers.left'
        db.add_column('vkontakte_groups_groupstatmembers', 'members_left', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        for stat in GroupStatMembers.objects.all():
            stat.update_migration()
            stat.save()

    def backwards(self, orm):

        # Deleting field 'GroupStatMembers.entered'
        db.delete_column('vkontakte_groups_groupstatmembers', 'members_entered')

        # Deleting field 'GroupStatMembers.left'
    ...
    models = {
        ...
        'vkontakte_groups.groupstatpersentage': {
            'Meta': {'ordering': "('group', '-type')", 'unique_together': "(('group', 'type', 'value_type'),)", 'object_name': 'GroupStatPersentage', 'db_table': "'vkontakte_groups_groupstatpercentage'"},
