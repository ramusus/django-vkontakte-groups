...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.photo'
        db.alter_column('vkontakte_groups_group', 'photo', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Group.photo_medium'
        db.alter_column('vkontakte_groups_group', 'photo_medium', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Group.photo_big'
        db.alter_column('vkontakte_groups_group', 'photo_big', self.gf('django.db.models.fields.URLField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Group.photo'
        db.alter_column('vkontakte_groups_group', 'photo', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Group.photo_medium'
        db.alter_column('vkontakte_groups_group', 'photo_medium', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Group.photo_big'
        db.alter_column('vkontakte_groups_group', 'photo_big', self.gf('django.db.models.fields.CharField')(max_length=100))
